...
<head>
    ...
    <style>
        ...
        .info { margin: 15px 0; padding: 10px; background: white; border-left: 4px solid #ff9800; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p class="warning">⏰ Cette intervention aura lieu dans <strong>2 heures</strong> !</p>
            ...
            <div class="info">
                ...
                <p><strong>Adresse :</strong> {{ $intervention->client->adresse ?? 'Non renseignée' }}</p>
            </div>
