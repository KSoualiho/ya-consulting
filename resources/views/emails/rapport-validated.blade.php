...
<head>
    ...
    <style>
        ...
        .success { background: #d4edda; border-left: 4px solid #28a745; padding: 10px; margin: 15px 0; color: #155724; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Bonne nouvelle ! Votre rapport a été validé.</p>
            
            <div class="success">
                <strong>✓ Validation confirmée</strong><br>
                Votre rapport pour l'intervention {{ $rapport->intervention?->numero ?? 'N/A' }} a été approuvé par le manager.
            </div>
            ...
            <div class="info">
                ...
                <p><strong>Date de validation :</strong> {{ date('d/m/Y H:i', strtotime($rapport->updated_at)) }}</p>
            </div>

            <p>Merci pour votre contribution et votre professionnalisme !</p>
            
            <p style="text-align: center;">
                <a href="{{ route('interventions.show', $rapport->intervention) }}" class="button">Voir l'intervention</a>
            </p>
        </div>
        <div class="footer">
